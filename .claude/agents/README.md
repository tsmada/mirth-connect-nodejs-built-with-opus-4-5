...
| [behavioral-comparison](./behavioral-comparison.md) | Compare Java vs Node.js behavioral outputs | Post-inventory-scan verification, pre-takeover validation, wrong-content diagnosis |
