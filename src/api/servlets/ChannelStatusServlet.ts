 ...
 */
channelStatusRouter.get(
  '/:channelId/status',
  authorize({ operation: CHANNEL_STATUS_GET, checkAuthorizedChannelId: 'channelId' }),
...
channelStatusRouter.get(
  '/statuses',
  authorize({ operation: CHANNEL_STATUS_GET_ALL }),
  async (req: Request, res: Response) => {
    try {
 ...
 */
channelStatusRouter.post(
  '/statuses/_getChannelStatusList',
  authorize({ operation: CHANNEL_STATUS_GET_ALL }),
  async (req: Request, res: Response) => {
    try {
...
channelStatusRouter.get(
  '/statuses/initial',
  authorize({ operation: CHANNEL_STATUS_GET_INITIAL }),
  async (req: Request, res: Response) => {
    try {
...
channelStatusRouter.post(
  '/:channelId/_start',
  authorize({ operation: CHANNEL_START, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
...
channelStatusRouter.post(
  '/_start',
  authorize({ operation: CHANNEL_START }),
  async (req: Request, res: Response) => {
    try {
...
channelStatusRouter.post(
  '/:channelId/_stop',
  authorize({ operation: CHANNEL_STOP, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
...
channelStatusRouter.post(
  '/_stop',
  authorize({ operation: CHANNEL_STOP }),
  async (req: Request, res: Response) => {
    try {
      const channelIds = req.body.channelId;
      const ids = channelIds ? (Array.isArray(channelIds) ? channelIds : [channelIds]) : [];
...
channelStatusRouter.post(
  '/:channelId/_halt',
  authorize({ operation: CHANNEL_HALT, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
...
channelStatusRouter.post(
  '/_halt',
  authorize({ operation: CHANNEL_HALT }),
  async (req: Request, res: Response) => {
    try {
      const channelIds = req.body.channelId;
      const ids = channelIds ? (Array.isArray(channelIds) ? channelIds : [channelIds]) : [];
...
channelStatusRouter.post(
  '/:channelId/_pause',
  authorize({ operation: CHANNEL_PAUSE, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
...
channelStatusRouter.post(
  '/_pause',
  authorize({ operation: CHANNEL_PAUSE }),
  async (req: Request, res: Response) => {
    try {
      const channelIds = req.body.channelId;
      const ids = channelIds ? (Array.isArray(channelIds) ? channelIds : [channelIds]) : [];
...
channelStatusRouter.post(
  '/:channelId/_resume',
  authorize({ operation: CHANNEL_RESUME, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
...
channelStatusRouter.post(
  '/_resume',
  authorize({ operation: CHANNEL_RESUME }),
  async (req: Request, res: Response) => {
    try {
      const channelIds = req.body.channelId;
      const ids = channelIds ? (Array.isArray(channelIds) ? channelIds : [channelIds]) : [];
 ...
 */
channelStatusRouter.post(
  '/:channelId/connector/:metaDataId/_start',
  authorize({ operation: CHANNEL_START, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
 ...
 */
channelStatusRouter.post(
  '/:channelId/connector/:metaDataId/_stop',
  authorize({ operation: CHANNEL_STOP, checkAuthorizedChannelId: 'channelId' }),
  async (req: Request, res: Response) => {
    try {
      const channelId = req.params.channelId as string;
