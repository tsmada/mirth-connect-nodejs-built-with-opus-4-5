...
configurationRouter.get(
  '/id',
  authorize({ operation: CONFIG_GET_SERVER_ID }),
...
configurationRouter.get(
  '/version',
  authorize({ operation: CONFIG_GET_VERSION }),
...
configurationRouter.get(
  '/buildDate',
  authorize({ operation: CONFIG_GET_BUILD_DATE }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/status',
  authorize({ operation: CONFIG_GET_STATUS }),
  (_req: Request, res: Response) => {
    res.sendData(0);
  }
);
...
configurationRouter.get(
  '/timezone',
  authorize({ operation: CONFIG_GET_TIMEZONE }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/time',
  authorize({ operation: CONFIG_GET_TIME }),
  (_req: Request, res: Response) => {
    res.sendData({
...
configurationRouter.get(
  '/jvm',
  authorize({ operation: CONFIG_GET_JVM }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/about',
  authorize({ operation: CONFIG_GET_ABOUT }),
  async (_req: Request, res: Response) => {
    try {
      const about = {
        name: 'Mirth Connect',
...
configurationRouter.get(
  '/settings',
  authorize({ operation: CONFIG_GET_SETTINGS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/settings',
  authorize({ operation: CONFIG_SET_SETTINGS }),
...
configurationRouter.get(
  '/encryption',
  authorize({ operation: CONFIG_GET_ENCRYPTION }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/charsets',
  authorize({ operation: CONFIG_GET_CHARSETS }),
  (_req: Request, res: Response) => {
    const charsets = [
      'UTF-8',
      'UTF-16',
...
configurationRouter.post(
  '/_generateGUID',
  authorize({ operation: CONFIG_GENERATE_GUID }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/globalScripts',
  authorize({ operation: CONFIG_GET_GLOBAL_SCRIPTS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/globalScripts',
  authorize({ operation: CONFIG_SET_GLOBAL_SCRIPTS }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/configurationMap',
  authorize({ operation: CONFIG_GET_CONFIG_MAP }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/configurationMap',
  authorize({ operation: CONFIG_SET_CONFIG_MAP }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/databaseDrivers',
  authorize({ operation: CONFIG_GET_DB_DRIVERS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/databaseDrivers',
  authorize({ operation: CONFIG_SET_DB_DRIVERS }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  ...
  authorize({ operation: CONFIG_GET_PASSWORD_REQUIREMENTS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/updateSettings',
  authorize({ operation: CONFIG_GET_UPDATE_SETTINGS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/updateSettings',
  authorize({ operation: CONFIG_SET_UPDATE_SETTINGS }),
  async (req: Request, res: Response) => {
    try {
      const settings = req.body;
...
configurationRouter.get(
  '/licenseInfo',
  authorize({ operation: CONFIG_GET_LICENSE }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/resources',
  authorize({ operation: CONFIG_GET_RESOURCES }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/resources',
  authorize({ operation: CONFIG_SET_RESOURCES }),
  async (req: Request, res: Response) => {
    try {
 ...
 */
configurationRouter.post(
  '/resources/:resourceId/_reload',
  authorize({ operation: CONFIG_RELOAD_RESOURCE }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/channelDependencies',
  authorize({ operation: CONFIG_GET_CHANNEL_DEPS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/channelDependencies',
  authorize({ operation: CONFIG_SET_CHANNEL_DEPS }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.get(
  '/channelTags',
  authorize({ operation: CONFIG_GET_CHANNEL_TAGS }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/channelTags',
  authorize({ operation: CONFIG_SET_CHANNEL_TAGS }),
  async (req: Request, res: Response) => {
    try {
      const tags = req.body;
...
configurationRouter.get(
  '/channelMetadata',
  authorize({ operation: CONFIG_GET_CHANNEL_METADATA }),
  async (_req: Request, res: Response) => {
    try {
...
configurationRouter.put(
  '/channelMetadata',
  authorize({ operation: CONFIG_SET_CHANNEL_METADATA }),
  async (req: Request, res: Response) => {
    try {
 ...
 */
configurationRouter.get(
  '/protocolsAndCipherSuites',
  authorize({ operation: CONFIG_GET_PROTOCOLS }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  ...
  authorize({ operation: CONFIG_GET_RHINO_VERSION }),
  (_req: Request, res: Response) => {
...
configurationRouter.get(
  '/configuration',
  authorize({ operation: CONFIG_GET_SERVER_CONFIGURATION }),
  async (_req: Request, res: Response) => {
    try {
      const [
        serverSettings,
...
configurationRouter.put(
  '/configuration',
  authorize({ operation: CONFIG_SET_SERVER_CONFIGURATION }),
  async (req: Request, res: Response) => {
    try {
...
configurationRouter.post(
  '/_testEmail',
  authorize({ operation: CONFIG_TEST_EMAIL }),
  async (req: Request, res: Response) => {
    try {
